...
module.exports = async (req, res) => {
  ...
  if (req.method === 'GET') {
    return res.status(200).json({
      ...
      method: 'POST',
      description: '图像风格转换API',
      parameters: {
        style_name: 'string (required) - 风格名称: 徽州生宣, 贵州皮纸, 棠岙竹纸, 西北毛边',
          ...
          messages: [
            {
              role: 'user',
              content: [
                { image: image_base64.startsWith('data:') ? image_base64 : `data:image/jpeg;base64,${image_base64}` },
